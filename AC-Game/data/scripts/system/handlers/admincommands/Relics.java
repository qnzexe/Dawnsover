 ...
 * @author Exe
 */
public class Relics extends AdminCommand {
	...
	public void execute(final Player player, String... params) {
		...
		ApByRelics = ApByRelics + (LASealItem.getItemCount())*1200;	
	...
	//	PacketSendUtility.sendMessage(player, LASeal + " Count for .62");
		...
		ApByRelics = ApByRelics + (ASealItem.getItemCount())*2400;	
	...
	//	PacketSendUtility.sendMessage(player, ASeal + " Count for .61");
		...
		ApByRelics = ApByRelics + (GASealItem.getItemCount())*3600;	
	...
	//	PacketSendUtility.sendMessage(player, GASeal + " Count for .60");
		...
		ApByRelics = ApByRelics + (MASealItem.getItemCount())*4800;	
	...
	//	PacketSendUtility.sendMessage(player, MASeal + " Count for .59");
		...
		ApByRelics = ApByRelics + (LAIconItem.getItemCount())*600;	
	...
	//	PacketSendUtility.sendMessage(player, LAIcon + " Count for .66");
		...
		ApByRelics = ApByRelics + (AIconItem.getItemCount())*1200;	
	...
	//	PacketSendUtility.sendMessage(player, AIcon + " Count for .65");
		...
		ApByRelics = ApByRelics + (GAIconItem.getItemCount())*1800;	
	...
	//	PacketSendUtility.sendMessage(player, GAIcon + " Count for .64");
		...
		ApByRelics = ApByRelics + (MAIconItem.getItemCount())*2400;	
	...
	//	PacketSendUtility.sendMessage(player, MAIcon + " Count for .63");
		...
		ApByRelics = ApByRelics + (LAGobletItem.getItemCount())*2400;	
	...
	//	PacketSendUtility.sendMessage(player, LAGoblet + " Count for .58");
		...
		ApByRelics = ApByRelics + (AGobletItem.getItemCount())*4800;	
	...
	//	PacketSendUtility.sendMessage(player, AGoblet + " Count for .57");
		...
		ApByRelics = ApByRelics + (GAGobletItem.getItemCount())*7200;	
	...
	//	PacketSendUtility.sendMessage(player, GAGoblet + " Count for .56");
		...
		ApByRelics = ApByRelics + (MAGobletItem.getItemCount())*9600;	
	...
	//	PacketSendUtility.sendMessage(player, MAGoblet + " Count for .55");
		...
		ApByRelics = ApByRelics + (LACrownItem.getItemCount())*4800;	
	...
	//	PacketSendUtility.sendMessage(player, LACrown + " Count for .54");
		...
		ApByRelics = ApByRelics + (ACrownItem.getItemCount())*9600;	
	...
	//	PacketSendUtility.sendMessage(player, ACrown + " Count for .53");
		...
		ApByRelics = ApByRelics + (GACrownItem.getItemCount())*14400;	
