 ...
 * @author Exe - update
 */
public class PSpeed extends AdminCommand implements StatOwner {
	...
	public void execute(Player admin, String... params) {
		...
		target.getGameStats().addEffect(this, functions);

		PacketSendUtility.broadcastPacket(target, new SM_EMOTION(target, EmotionType.START_EMOTE2, 0, 0), true);
	} }
